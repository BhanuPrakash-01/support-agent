...
def progress_ok():
    ...
    if "## Next Action" not in md:
        raise RuntimeError("no Next Action section")
    if md.rstrip().endswith("TODO"):
        raise RuntimeError("Next Action still says TODO")
